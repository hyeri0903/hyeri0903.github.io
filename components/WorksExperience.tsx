...
const Features = () => {
  ...
  return (
    <section className="mx-auto px-4 py-24 bg-white dark:bg-black transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center w-full">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 dark:text-white mb-4 text-center w-full">
            WorkExperience
          </h2>
          <p className="mt-8 text-xl text-gray-900 dark:text-white font-light text-center w-full">
